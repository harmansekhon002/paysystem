...
# Configuration
DATABASE_URL = os.environ.get('DATABASE_URL', 'postgresql://neondb_owner:npg_ubgGx57adsrU@ep-rough-glade-aeildi2w-pooler.c-2.us-east-2.aws.neon.tech/neondb?sslmode=require')
